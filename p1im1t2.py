...
if __name__ == '__main__':
    ...
    #     resultImg = 255 * (np.abs(logImg) < 0.2)
    ...
    #     resultImg = 255 * (np.abs(lapImg) < 0.2)
    ...
    # douThres = doubleThresholds(nmsMag, thres, thres / 2, False, iter, seSize)
